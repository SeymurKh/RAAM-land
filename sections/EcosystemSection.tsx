...
function TiltCard({
  ...
  return (
    <motion.div
      ...
      className="group rounded-[1.25rem] border border-white/10 bg-white/3.5 p-3 backdrop-blur-xl transition duration-500 hover:-translate-y-1 hover:border-stone-100/24 hover:bg-white/6.5 sm:rounded-3xl sm:p-5"
    >
      {children}
    </motion.div>
  );
